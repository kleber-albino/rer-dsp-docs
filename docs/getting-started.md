...
Esse passo cria os containers Docker, sobe os bancos (dsp-db, dsp-geoserver-db) e os GeoServers (Exhibition + Download), e aplica o **seed SQL** de demonstração. **Não** sobe o job de migração nem pede fonte JDBC.
